...
const UpdatePet = (props) => {
    ...
    const [formData, handleInputChange, handleSubmit] = useCustomForm(initialValues, updatePet)


    useEffect (() => {
        const updatePet = async() => {
            try {
                let response = await axios.put(`http://127.0.0.1:8000/pets/alterpet/${1}/`, formData, {
                    headers: {
