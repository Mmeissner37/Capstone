    ...
    <div className="reg-page">
      <div className="container">
        <form className="form" onSubmit={handleSubmit}>
          ...
          <label> Check here if you are a veterinary professional:
          <input type="checkbox" name="is_vet" value={formData.is_vet} onChange={handleInputChange} />
          </label>
